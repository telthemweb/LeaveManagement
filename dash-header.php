                ...
                <ul id="more" class="collapse toggle-collapse">
                    ...
                    <li>
                        <a href="dashboard.php?tab=3">
                         ...
                         <li>
                        <a href="/LeaveManager/Leavf/emp_leavcount.php">
                            <i class="fa fa-calculator icon"></i>
                            <span class="extra-sm break">My Leave Days</span>
                        </a>
                    </li>
                    <li>
...
<?php   if($level == "supervisor"){
            ...
            echo'<li style="list-style:none;">
                    <a href="/LeaveManager/Leavf/suplistep.php?tab=12">
                        <i class="fa fa-recycle icon"></i>
                        <span class="extra-sm break">Employee On Leave</span>
                    </a>
                </li>';
            }
        ...
        ?>
            ...
            <li class="list-main">
             ...
             <li class="list-main">
                <a href="/LeaveManager/Leavf/ListAllOnLeave.php">
                <i class="fa fa-recycle icon"></i>
                <span class="extra-sm break">
                   Employee On Leave
                </span>
